...
class OrderPageLocators:
    ...
    METRO_STATION_BY_NAME = (By.XPATH, ".//div[@class='select-search__select']//li[@data-value]")
    ...
    def get_metro_station_locator(station_name):
        return (By.XPATH, f".//div[@class='select-search__select']//li[@data-value]//*[contains(text(), '{station_name}')]")